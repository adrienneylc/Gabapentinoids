...
```{r 0. Load packages, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
library(tidyverse)
library(broom)
...
```{r message=FALSE, warning=FALSE,out.width='80%', echo=FALSE}
...
```
#### Gabapentin  
```{r message=FALSE, warning=FALSE,out.width='80%', results='hide'}
library(DT)
library(data.table)
...
### Result table    
```{r message=FALSE, warning=FALSE,out.width='120%'}
